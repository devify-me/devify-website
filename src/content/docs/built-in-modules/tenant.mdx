...
| GET | `/tenants/` | List tenants for the authenticated user |
| GET | `/tenants/{id}` | Get tenant by ID |
| PATCH | `/tenants/{id}` | Update tenant name/settings |
| DELETE | `/tenants/{id}` | Delete a tenant |
| GET | `/tenants/{id}/members` | List tenant members |
| POST | `/tenants/{id}/members` | Add a member to the tenant |
| PATCH | `/tenants/{id}/members/{uid}` | Update a member's role |
| DELETE | `/tenants/{id}/members/{uid}` | Remove a member |
| POST | `/tenants/{id}/invites` | Create an invitation |
